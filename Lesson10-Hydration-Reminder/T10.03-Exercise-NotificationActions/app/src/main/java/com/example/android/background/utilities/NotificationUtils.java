...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 7852;

    private static final int ACTION_DRINK_PENDING_INTENT_ID =2430;
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        Intent drinkReminderIntent = new Intent(context, WaterReminderIntentService.class);

        //      COMPLETE (13) Set the action of the intent to designate you want to increment the water count
        drinkReminderIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        //      COMPLETE (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent drinkReminderPendingIntent = PendingIntent.getService(
                context,
        ...
        NotificationCompat.Action drinkReminderAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                "I did it!",
                drinkReminderPendingIntent);

        //      COMPLETE (16) Return the action
        return drinkReminderAction;
    }
