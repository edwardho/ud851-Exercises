...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_QUERY_RAW_JSON = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String urlExtraStore = savedInstanceState.getString(SEARCH_QUERY_URL_EXTRA);
            String rawJsonStore = savedInstanceState.getString(SEARCH_QUERY_RAW_JSON);

            mUrlDisplayTextView.setText(urlExtraStore);
            mSearchResultsTextView.setText(rawJsonStore);
        }
    }
